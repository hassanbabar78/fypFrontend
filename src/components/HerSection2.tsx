...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen pt-32 px-6 py-16 overflow-hidden z-10">
        ...
        <div className="space-y-6 text-center lg:text-left">
          <div 
            className={`inline-flex items-center gap-2 px-4 py-2 border  rounded-full ${
              showIframe ? 'text-[#0c5d14] border-[#0c5d14]' : 'text-[#000000] border-[#000000]'
            }`}
          >
            <Shield className="w-4 h-4" /> Blockchain Security
          </div>
          ...
          <p className="max-w-xl transition-colors duration-700 text-white">
            Next-generation digital identity verification with{" "}
            <span className="font-semibold transition-colors duration-700 text-white">
          ...
          <div className="flex gap-4 justify-center lg:justify-start">
            <Button size='lg' className={`px-8 py-4 bg-white rounded-lg font-bold text-black flex items-center gap-2`}>
              Get Started <ArrowRight className="w-5 h-5" />
            </Button>
            <Button size='lg' variant='default' className={`px-8 py-4 border rounded-lg transition-colors duration-700 border-white text-white`}>
              Documentation
            </Button>
          </div>

          <div className="grid grid-cols-2 gap-3 max-w-xl">
            {[Lock, Zap, Database, Activity].map((Icon, i) => (
              <div key={i} className="flex gap-2 text-sm transition-colors duration-700 text-white">
                <Icon className="w-4 h-4 transition-colors duration-700 text-white" /> Secure Feature
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Stats */}
      <div className="mt-16 grid grid-cols-3 gap-6 max-w-3xl mx-auto border-2">
        <div className="text-center">
          <div className="text-3xl sm:text-4xl font-black text-white mb-1">99.99%</div>
          <div className="text-zinc-500 text-sm">Uptime</div>
        </div>
